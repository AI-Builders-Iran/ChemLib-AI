"""
DocumentAI structured-extraction demo (Streamlit).

This is the original demo UI (invoice / contract / general extraction). The
client-facing library app (user chat + admin panel) is ``app.py``.
...
load_dotenv(ROOT_DIR / ".env")  # lets the demo pick up GEMINI_API_KEY / OPENROUTER_API_KEY
